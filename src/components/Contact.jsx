...
export default function Contact() {
  ...
  return (
    <section id="kontak" className="relative pt-32 pb-16 bg-[var(--color-nocturne-base)] min-h-[90vh] flex flex-col justify-between">
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-end">
          ...
          >
            ...
            <h2 className="editorial-heading text-6xl md:text-[6rem] text-cream leading-[0.9] tracking-tight">
              Let's <br/> talk.
            </h2>
          </motion.div>
      ...
      {/* Footer */}
      <footer className="w-full max-w-7xl mx-auto px-6 md:px-12 mt-32 flex flex-col md:flex-row justify-between items-center gap-4 editorial-mono text-[10px] text-cream-dim">
